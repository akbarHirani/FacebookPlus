 ...
 * @author Kal
 */
@WebServlet(name = "ToggleLikeServlet", urlPatterns = {"/ToggleLikeServlet"})
public class ToggleLikeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(uClient.userLikesComment(commentIDlong)) {
                //Change to unlike by removing the entry and decrementing the val
                uClient.unlikeComment(commentIDlong);
            }else{
                //Change to like
                uClient.likeComment(commentIDlong);
            }
