...
public class EditAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String accId = request.getParameter("account_to_edit");
            long accIdL = Long.parseLong(accId);
            
            String ccNumber = request.getParameter("ccnumber");
            long ccNumL = Long.parseLong(ccNumber);
            
            uClient.updateCCNumber(accIdL, ccNumL);
            
            response.sendRedirect(request.getContextPath()+"/user/edit_accounts.jsp");
        } catch (Exception ex) {
