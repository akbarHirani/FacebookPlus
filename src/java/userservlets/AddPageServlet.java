 ...
 * @author Kal
 */
@WebServlet(name = "AddPageServlet", urlPatterns = {"/AddPageServlet"})
public class AddPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Build Comment
            long circleIDLong = Long.parseLong(circleID);
            long nextId = uClient.getNextPageId();
            long userID = usBean.getUserID();
            Date date = new Date(System.currentTimeMillis());
            
            Page page = new Page(nextId, 0 , circleIDLong);
            uClient.insertPage(page);
