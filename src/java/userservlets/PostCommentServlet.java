...
public class PostCommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            long nextId = uClient.getNextCommentID();
            long userID = usBean.getUserID();
            Date date = new Date(System.currentTimeMillis());
            String content = request.getParameter("postCommentContent");
            
            Comment comment = new Comment(nextId, date, content, postIDLong, userID, 0);
            uClient.insertComment(comment);
