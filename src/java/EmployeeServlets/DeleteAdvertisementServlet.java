 ...
 * @author Jacky
 */
@WebServlet(name = "DeleteAdvertisementServlet", urlPatterns = {"/DeleteAdvertisementServlet"})
public class DeleteAdvertisementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            long a_id=Long.parseLong(advertisement_id);
            ...
            employeeClient.deleteAdvertisement(a_id);
